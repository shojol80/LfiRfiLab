...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="index.php?page=page1.php">Page 1
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="list-group">
            <a href="vulnerabilities/lfi/lfi.php" class="list-group-item">Local File Inclusion</a>
            <a href="vulnerabilities/rfi/rfi.php" class="list-group-item">Remote File Inclusion</a>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">© DIUISACA Student Group</p>
      </div>
      <!-- /.container -->
    </footer>
